...
def pdf_extract():
    ...
    # BANCOLOMBIA
    json_path = Path(r"C:\Users\USUARIO\OneDrive\Nima Cloud\02 Desarrollo de Producto\PBA\data\input_pdfs\Unlocked Bancolombia\Textract Response\analyzeDocResponse.json")
